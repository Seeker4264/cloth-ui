...
export const Input: React.FC<InputProps> = ({
  ...
  const inputClasses = {
    primary: {
      input: `peer px-4 py-2 w-full text-lg outline-none border-2
          ${error ? "border-red-600" : "border-[#999]"} rounded-lg bg-white
          focus:border-[#498BFF]
          disabled:bg-[#DDD]
          duration-150`,
      label: `absolute left-0 top-3 ml-4! ${error ? "text-red-600" : "text-[#777]"} capitalize tracking-wide pointer-events-none bg-white
